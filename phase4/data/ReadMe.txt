(1) Get the embedded dataset from the following link and put to here. The embedded dataset file is empty currently.
https://staff.stat.sinica.edu.tw/chyeang/ME/PlantDisease_embeddings.zip
