...
function [nseeds, seedinds, bilabels, regionpairD, nbregioninds] = generate_seedregions_package2(data, augdata, tsnedata, regionneighborlabels, filter, numthre, fracthre, topthre, nimagesthre, mthre, lwdthre, uppthre, nmarkersthre, rankthre, rankratiothre, overlapthre, sizethre, disparitythre, highthre, dthre, nnbsthre, sharedthre, nvalidnbsthre, rthre, regionpairDmode, maxnseeds, nclassesthre, ratiothre, foldthre, diffratiothre)
