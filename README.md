...
4. Phase 4. Copy three output files from phase3 into the phase4/data/. Hyperparameter 'MNIST_merge_seedregions_params.txt' hass been in phase4/data/. Run 'merge_seedregions_package.m'. It will output one file.
